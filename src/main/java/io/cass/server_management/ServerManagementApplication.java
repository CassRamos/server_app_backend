package io.cass.server_management;
...
public class ServerManagementApplication {
    ...
    CommandLineRunner runner(ServerRepo serverRepo) {
        return args -> {
            ...
            serverRepo.save(new Server(null, "192.168.0.94", "Red Hat Enterprise Linux", "64 GB", "Mail Server", "http://localhost:8080/server/image/server4.png", Status.SERVER_DOWN));
